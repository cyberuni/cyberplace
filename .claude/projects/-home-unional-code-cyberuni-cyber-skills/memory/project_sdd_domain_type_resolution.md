...
description: SDD plugin delegates resolve by domain-type (artifact-type axis), not the spec folder name; fixed the bug where ACES never fired
metadata:
  type: project
---
