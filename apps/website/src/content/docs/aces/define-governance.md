...
If the content is *what to enforce*, it's a governance file; if it's *how to do something*, route to [`define-skill`](/aces/define-skill/) instead.
...
Run [`sdd:start-mission`](/sdd/overview/) to spec and eval the governance file; the conductor resolves the ACES roles automatically.
