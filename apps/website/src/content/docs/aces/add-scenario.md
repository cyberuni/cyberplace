...
**Trigger:** adding a new test case to an ACES golden set — from a real failure, a production edge case, or a gap the user noticed
...
Run [`run`](/aces/run/) to score the new case against the current agent configuration.
