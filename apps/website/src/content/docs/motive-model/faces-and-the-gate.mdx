...
- Applied **forward**, it produces — a Builder writes code, an Architect draws structure, a Framer frames a problem.
- Applied **backward**, the same expertise *judges* — the Builder validates the code, the Architect runs a fit-to-structure review, the Framer makes a kill-or-ship call.
