...
| **Actor** | The narrow case of a **role**: one of the four motive-distinct base roles — Oracle, Builder, Architect, Strategist — and the human party in the **actor/delegate** pair. Holds accountability, which never delegates. *Collision: unlike a UML use-case "actor" (which may be a non-human system), our actor is **always human** — agents are delegates.* |
