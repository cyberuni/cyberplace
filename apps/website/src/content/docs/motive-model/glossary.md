...
| **Motive** | The intrinsic **want** that defines an actor — *face-invariant*: both faces serve it. Named by its forward verb for brevity — **intend** (Framer: the right thing exists), **generate** (Builder: the thing works), **structure** (Architect: the whole stays coherent and evolvable), **accumulate** (Curator: knowledge compounds) — but the **backward face** pursues the same want by *judging against* it, not producing toward it. |
