...
<CardGrid>
	<Card title="Framer" icon="seti:default">
	...
	<Card title="Curator" icon="seti:db">
...
<Mermaid
    ...
    C["<b>Curator</b> · curation<br/>generalize across products<br/><i>lives in: the corpus — outlives the product</i>"]
...
The Framer owns *whether and why*; the Builder owns *how*. A Builder who redefines the goal has stepped into the Framer role.
</Aside>
