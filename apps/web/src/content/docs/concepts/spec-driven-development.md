...
- **Rapidly changing requirements** — if requirements shift weekly, even AI-assisted spec updates become more churn than value; the spec will always be one cycle behind
