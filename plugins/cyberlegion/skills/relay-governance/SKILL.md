...
description: "Internal skill: by name only — the Legion's report/ask contract — how a headless agent returns a result or surfaces a question it cannot answer. Loaded by dispatch-governance and any headless agent. Not triggered by users directly."
