...
**not** a ship (no tracked `.agents/cyberlegion/config.json` marker at this project root, per ADR-0022).
...
- You are outside any ship (no `.agents/cyberlegion/` marker here) and need to init or spawn a first ship.
