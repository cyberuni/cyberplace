...
| **Boolean Gherkin by default** | Every `Then` is an observable, deterministic boolean — outputs, exit codes, side effects. Never internal state or the authoring process. |
