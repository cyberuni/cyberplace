...
It is the runnable surface parallel to the mission loop: the Operator (`sdd-operator`) runs the middle loop per segment; the Scanner runs this outer loop at lifecycle granularity. The Scanner is the **sole writer** of `strategy` log entries.
