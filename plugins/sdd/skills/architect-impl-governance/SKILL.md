...
description: "Internal skill: by name only — the Architect actor bar at the impl gate — structural fit of the implementation. Loaded by the impl-producer and the impl-judge, not user-triggered."
