...
description: "Internal skill: the Architect actor bar at the spec gate — structural fit of the spec and solution. Loaded by the solution-producer and the cold spec-judge, not user-triggered."
