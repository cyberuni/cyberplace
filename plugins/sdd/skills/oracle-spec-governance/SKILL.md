...
description: "Internal skill: the Oracle actor bar at the spec gate — scope and kill-or-ship. Loaded by the spec-producer and the cold spec-judge, not user-triggered."
