...
The concrete engine for **SDD governance resolution** (`.agents/specs/sdd/design/governance-resolution.md`).
...
- **Rule side:** `.agents/specs/sdd/design/governance-resolution.md`
