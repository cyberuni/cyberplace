...
The concrete engine for the SDD **`intake/plan-discovery`** unit
(`.agents/specs/sdd/intake/plan-discovery/`). A non-user-invocable skill carrying a self-contained
...
- **Spec:** `.agents/specs/sdd/intake/plan-discovery/`
