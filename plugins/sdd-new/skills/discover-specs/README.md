...
The concrete engine for the SDD **`corpus/discovery`** unit
(`.agents/specs/sdd/corpus/discovery/`). A non-user-invocable skill carrying a self-contained `.mts`
...
- **Spec:** `.agents/specs/sdd/corpus/discovery/`
