---
name: retire skill-authoring/create-skill in favor of aced:define-skill
overview: >
  plugins/skill-authoring/skills/create-skill duplicates aced:define-skill's scope (near-
  ...
  in favor of define-agent). Blocked on define-skill's ACED eval-loop default being too heavy
...
(`5fd3840`, same session). Blocked immediately on define-skill's ACED-eval-loop default being
...
- `plugins/aced/skills/define-skill/SKILL.md` — needs the escaped-path decision above
