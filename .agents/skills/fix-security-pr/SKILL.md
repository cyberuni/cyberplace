...
description: "Fix a PR that is failing due to security or vulnerability issues — npm/pnpm/yarn/bun audit failures, CVE alerts, Dependabot merge conflicts, Snyk failures, or GitHub security advisory blocks. Use this skill when asked to 'fix the security PR', 'resolve the vulnerability failure', or 'unblock the Dependabot PR'."
metadata:
  internal: true
---
