...
flowchart TD
  ...
  D4["D4 · strategy — recommend / offer / bar"] -->|"src/ named for what it does, or capabilities stated"| ST1["capability-first"]
...
| D4-rec | detection · src/ top-level folders named for what the project does | `a project with a discernible capability decomposition is recommended capability-first` |
...
| DECL | hoisted · repo-root dir name differs from package name | `a name that is not reliably derivable is confirmed with the user before writing` |
