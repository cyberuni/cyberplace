...
| `resolution` | `design/governance-resolution.md` (rule) · `design/specialists-and-squads.md` (rule) · `mission/read-check/` (behavior) · `mission/resolution/` (behavior) · `workflows/` (workflow) |
