...
The **organization strategy** (`capability-first`, …) is declared in the **body** (the placement map), not frontmatter — read on demand by `scaffold-project-spec` / the formation Warden, off the router's hot path (`../design/spec-layout.md`).
