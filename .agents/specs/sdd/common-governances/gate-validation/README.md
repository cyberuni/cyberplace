...
how a gate records its verdict. A fixed-universal SDD governance loaded by spec-gate, the
...
- **Conformance** — verified through `../../authoring/spec-gate/` (and the mechanical
...
- **Boundary** — the **model folds into `../../design/lifecycle-model.md`** (the legal-state tuples,
  the two gates, derived sync, and gate accountability already live there — there is no
