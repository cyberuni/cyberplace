Feature: add — add a test case to the golden set
  ...
  Scenario: a failure the user wants captured as a new case triggers add
  ...
  Scenario: the draft carries every required section
    ...
    When add scaffolds the test case
  ...
  Scenario: a rejected draft is revised instead of written
    ...
    When add handles the rejection
