...
User asks for an eval spec for the `improve` skill. `aces-spec-designer` completes and returns `STRUCTURAL_ISSUES: S4 — Referenced file does not exist`.
...
- Omit structural issues from the report when they are returned by aces-spec-designer
