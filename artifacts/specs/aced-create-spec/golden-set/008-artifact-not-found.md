...
- Does not invoke `aced-spec-designer` with a missing file

## Must NOT do

- Invoke `aced-spec-designer` with an empty or placeholder artifact body
- Silently create an eval spec for the wrong file

## Rubric

Score 1–5:
5 — Clear "not found" message, asks for verification, does not invoke aced-spec-designer
...
2 — Invokes aced-spec-designer with empty content
