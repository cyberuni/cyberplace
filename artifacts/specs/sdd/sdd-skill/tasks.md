# Tasks: SDD Skill Context Workflow

Each task is an executable unit; dependencies are noted. Order is emergent from dependencies.

## Phase 1 - Workflow artifacts

- [x] Write `spec.md` for the `sdd` context skill workflow — serves: context skill behavior, routing surface, nested graph requirement
- [x] Write `sdd-skill.feature` scenarios — deps: spec.md — serves: context loading, routing, freeze enforcement, no project mutation
