...
- Passes `SUBJECT_PATH` as `plugins/aces/skills/create-spec/SKILL.md`
- The eval directory (created by aces-spec-designer) uses the plugin-prefix convention: `artifacts/specs/aces-create-spec/`
