...
- Agent redirects to `aced:create-spec` (which the skill's own Report section suggests as the next step)
...
- Agent response mentions `aced:create-spec` or equivalent redirect

## Rubric

Score 1–5:
5 — Redirects to `aced:create-spec` explicitly; explains this is the designated next step from the report
4 — Redirects to a spec/eval tool; may not name `aced:create-spec` exactly
