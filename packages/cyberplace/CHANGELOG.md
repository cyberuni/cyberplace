...
- 2ffd823: `skill-design` governance: document the governance lookup order a skill follows at run time — project override, then an installed `buddy-agent-harness` copy when present, then the skill's own committed `references/governances/<name>.md`.
