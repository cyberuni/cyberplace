...
export function findCommand(): Command {
	return new Command('find')
		.description('Search for available skills (default: cyberuni/cyberplace)')
...
export function migrateCommand(): Command {
	return new Command('migrate')
		.description('Migrate skills-lock.json (npx skills) to .agents/cyberplace-lock.json')
		.addOption(ROOT_OPTION)
...
export function configCommand(): Command {
	const cmd = new Command('config').description('Manage cyberplace configuration')
